...
import { fetchGraph, querySyllabus, uploadSyllabus, reprocessGraph } from "@/lib/api"
...
function SyllabusWorkspace() {
  ...
  const sendMessage = useCallback(
    (text: string) => {
      ...
      // Consumimos el servicio querySyllabus de la capa de API centralizada
      querySyllabus(activeSyllabusId, trimmed)
      .then((data) => {
  ...
  const addAttachment = useCallback(async (file: AttachedFile) => {
    ...
    if (file.file) {
      try {
        // Consumimos el servicio uploadSyllabus de la capa de API centralizada
  ...
  const loadGraph = useCallback(async () => {
    ...
    try {
      // Consumimos el servicio fetchGraph de la capa de API centralizada
  ...
  const handleReprocessGraph = useCallback(async () => {
    ...
    try {
      // Consumimos el servicio reprocessGraph de la capa de API centralizada
